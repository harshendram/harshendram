...
| :----: | :---------------------- |
| **A7** | [A5](https://github.com/harshendram/harshendram/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A7+to+A5), [A6](https://github.com/harshendram/harshendram/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A7+to+A6) |
| **A8** | [B8](https://github.com/harshendram/harshendram/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A8+to+B8) |
...
| `E2` to `E4` | [ @harshendram](https://github.com/harshendram) |
...
| 2 | [@Nihalnshetty](https://github.com/Nihalnshetty) |
